...
[![Spring Boot](https://img.shields.io/badge/Spring%20Boot-3.0.4-blue.svg)]()
[![JDK-11](https://img.shields.io/badge/JDK-17-green.svg)]()

> base-cloud `分布式微服务后台框架` 基于最新spring-cloud-alibaba微服务组件 dubbo3.2 spring-boot 3.0.4开发 JDK最低要求为17

### (逐步完善)
| 功能介绍      | 使用技术                              | 文档地址                                                                                               | 特性注意事项                            |
|-----------|-----------------------------------|----------------------------------------------------------------------------------------------------|-----------------------------------|
| 后端开发框架    | SpringBoot 3.0.4                  | [SpringBoot官网](https://spring.io/projects/spring-boot/#learn)                                      |                                   |
| 微服务开发框架   | SpringCloud 2022.0.1              | [SpringCloud官网](https://spring.io/projects/spring-cloud)                                           |                                   |
| 微服务开发框架   | SpringCloudAlibaba 2022.0.0.0-RC1 | [SpringCloudAlibaba官网](https://spring.io/projects/spring-cloud-alibaba)                            |                                   |
...
| 分布式注册中心   | Alibaba Nacos 2.2.0               | [Alibaba Nacos文档](https://nacos.io/zh-cn/docs/quick-start.html)                                    | 采用2.X 基于GRPC通信高性能                 |
| 分布式配置中心   | Alibaba Nacos 2.2.0               | [Alibaba Nacos文档](https://nacos.io/zh-cn/docs/quick-start.html)                                    | 采用2.X 基于GRPC通信高性能                 |
...
| RPC远程调用   | Apache Dubbo  3.2.0-beta.5        | [Apache Dubbo官网](https://dubbo.apache.org/zh/)                                                     | 原生态使用体验、高性能                       |
| 分布式限流熔断   | Alibaba Sentinel                  | [Alibaba Sentinel文档](https://sentinelguard.io/zh-cn/)                                              | 无侵入、高扩展                           |
| 分布式事务     | Alibaba Seata  1.6.1              | [Alibaba Seata文档](http://seata.io/zh-cn/)                                                          | 无侵入、高扩展 支持 四种模式                   |
